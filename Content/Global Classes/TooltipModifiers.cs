...
namespace CombinationsMod.Content.Global_Classes
{
   public class TooltipModifiers : GlobalItem
   {
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            ...
            {
                tooltips.Add(new TooltipLine(Mod, "CounterweightStackInfo", Language.GetTextValue("Mods.CombinationsMod.LocalizedText.Misc.CounterweightPerYoyo")));
            }
            ...
            {
                tooltips.Add(new TooltipLine(Mod, "YoyoStringInfo", Language.GetTextValue("Mods.CombinationsMod.LocalizedText.Misc.150YoyoRange")));
            }
