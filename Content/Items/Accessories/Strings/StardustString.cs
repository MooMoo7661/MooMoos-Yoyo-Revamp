...
{
    public class StardustString : ModString
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.GetModPlayer<YoyoModPlayer>().YoyoStringColor = new(90, 195, 248);
        ...
        {
            Lighting.AddLight(Item.Center, Color.LightBlue.ToVector3() * 0.8f);
            ...
            for (float i = 0; i < 1; i += 1f / numberOfCloneImages)
            {
                ...
                Color color = Color.LightBlue * 0.3f;
