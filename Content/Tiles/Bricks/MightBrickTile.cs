...
{
    public class MightBrickTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<MightBrick>());
        ...
        {
            Lighting.AddLight(new Vector2(i, j) * 16, TorchID.Blue);
            for (int x = 0; x < 4; x++)
                Dust.NewDust(new Vector2(i, j) * 16, 16, 16, DustID.BlueTorch);
        }
    }
}
